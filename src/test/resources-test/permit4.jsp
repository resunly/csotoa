...
<TABLE id=fd_2f4bbd16f8efd0 class=tb_normal align=center label="主表" style="width:100%;">
    <TBODY>
    <TR>
        <TD class=td_normal_title style="WIDTH: auto" width=1514 colSpan=7 align=right row="0" column="0,1,2,3,4,5,6">
    ...
    <TR>
        ...
        <TD style="WIDTH: 206px" width=211 row="1" column="3">
        ...
        <TD style="HEIGHT: auto; WIDTH: 570px" rowSpan=2 width=467 row="1,2" column="6">
    ...
    <TR style="HEIGHT: 32px">
        ...
        <TD style="WIDTH: 206px" width=211 row="2" column="3">

            <xform:right mode_g="view" mode_d="view" mode_N16="hidden" def_N16="true">
                <DIV style="WORD-WRAP: break-word; WIDTH: 162px; WORD-BREAK: break-all; DISPLAY: inline" canShow="true">
                    <xform:xtext property="extendDataFormInfo.value(fdBDTER)" style="WIDTH: 157px" required="false"
                                 subject="${xform:subject('fdBDTER','label')}"
                                 title="${xform:subject('fdBDTER','label')}" onValueChange="__xformDispatch"/></DIV>
    ...
    <TR>
        <TD class=td_normal_title style="WIDTH: auto" width=1514 colSpan=7 row="3" column="0,1,2,3,4,5,6">
    ...
    <TR>
        ...
        <TD style="WIDTH: auto" width=1367 colSpan=6 row="4" column="1,2,3,4,5,6">

            <xform:right mode_g="view" mode_d="view" mode_N5="edit" mode_N16="hidden" def_N5="false" def_N16="false">
    ...
    <TR>
        ...
        <TD style="WIDTH: auto" width=1367 colSpan=6 row="5" column="1,2,3,4,5,6">
    ...
    <TR style="HEIGHT: 106px">
        ...
        <TD style="WIDTH: auto" width=1367 colSpan=6 row="6" column="1,2,3,4,5,6">
    ...
    <TR>
        <TD class=td_normal_title style="WIDTH: auto" width=1514 colSpan=7 row="7" column="0,1,2,3,4,5,6">
            <LABEL style="TEXT-DECORATION: none; FONT-FAMILY: null;  FONT-WEIGHT: normal; FONT-STYLE: normal; DISPLAY: inline"><xform:lang
